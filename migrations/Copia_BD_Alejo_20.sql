...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `trg_generar_numero_postulacion` AFTER INSERT ON `Postulacion` FOR EACH ROW BEGIN
  UPDATE Postulacion
  SET numeroPostulacion = CONCAT('PO', NEW.OIDPostulacion)
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `trg_generar_numero_proyecto` AFTER INSERT ON `Proyecto` FOR EACH ROW BEGIN
    -- Actualiza el numeroProyecto concatenando 'PRJ' con el OID recién insertado
    UPDATE Proyecto
    SET numeroProyecto = CONCAT('PRJ', NEW.OIDProyecto)
    WHERE OIDProyecto = NEW.OIDProyecto;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `trg_generar_cod_proyecto_puesto` AFTER INSERT ON `ProyectoPuesto` FOR EACH ROW BEGIN
    -- Asigna el código automáticamente después de insertar
    UPDATE ProyectoPuesto
    SET codProyectoPuesto = CONCAT('PP', LPAD(NEW.OIDProyectoPuesto, 4, '0'))
    WHERE OIDProyectoPuesto = NEW.OIDProyectoPuesto;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2025-10-16  0:44:02
