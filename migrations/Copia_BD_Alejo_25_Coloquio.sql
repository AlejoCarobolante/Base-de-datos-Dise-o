...
--
-- Host: caboose.proxy.rlwy.net    Database: coloquio_ds_2025
-- ------------------------------------------------------
...
INSERT INTO `ProyectoUniversidad` VALUES (1,1,9,'2024-12-09',NULL),(2,2,10,'2024-08-19',NULL),(3,3,3,'2024-09-16',NULL),(4,3,9,'2024-09-18',NULL),(5,3,12,'2024-09-20',NULL),(6,4,2,'2025-04-21',NULL),(7,4,1,'2025-04-19',NULL),(8,5,7,'2024-09-03',NULL),(9,5,6,'2024-09-10',NULL),(10,5,1,'2024-09-07',NULL),(11,6,2,'2025-01-15',NULL),(12,6,4,'2025-01-17',NULL),(13,6,7,'2025-01-18',NULL),(14,6,6,'2025-01-20',NULL),(15,6,1,'2025-01-14',NULL),(16,7,12,'2024-11-18',NULL),(17,7,11,'2024-11-24',NULL),(18,7,3,'2024-11-24',NULL),(19,7,9,'2024-11-22',NULL),(20,8,7,'2024-11-16',NULL),(21,8,6,'2024-11-18',NULL),(22,8,1,'2024-11-18',NULL),(23,9,8,'2024-12-12','2025-03-12'),(24,10,11,'2024-11-28','2025-04-27'),(25,11,2,'2024-08-15',NULL),(26,11,1,'2024-08-20',NULL),(27,11,4,'2024-08-15',NULL),(28,12,3,'2024-09-08',NULL),(29,12,9,'2024-09-09',NULL),(30,22,2,'2025-10-16',NULL),(31,23,3,'2025-10-22',NULL),(32,23,2,'2025-10-22',NULL);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `trg_check_baja_universidad` BEFORE UPDATE ON `Universidad` FOR EACH ROW BEGIN
    ...
    -- Evita volver a dar de baja una universidad ya dada de baja
    IF OLD.fechaBajaUniversidad IS NOT NULL 
       AND NEW.fechaBajaUniversidad = OLD.fechaBajaUniversidad THEN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `trg_check_baja_universidad_proyecto_universidad` BEFORE UPDATE ON `Universidad` FOR EACH ROW BEGIN
    DECLARE v_count INT;
    DECLARE v_msg VARCHAR(255);

    -- Solo validar cuando se intenta establecer una fecha de baja (y antes no la tenía)
    IF NEW.fechaBajaUniversidad IS NOT NULL AND OLD.fechaBajaUniversidad IS NULL THEN

        -- Contar proyectos con estados distintos de 1, 5 y 6
        SELECT COUNT(*)
        INTO v_count
        FROM Proyecto p
        INNER JOIN ProyectoUniversidad pu 
            ON pu.OIDProyecto = p.OIDProyecto
        WHERE pu.OIDUniversidad = OLD.OIDUniversidad
          AND p.OIDEstadoProyecto NOT IN (1, 5, 6);

        -- Si existe al menos uno, bloquear la baja
        IF v_count > 0 THEN
            SET v_msg = 'No se puede dar de baja la universidad: tiene proyectos en estados distintos de 1, 5 o 6.';
            SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = v_msg;
        END IF;
    END IF;
...
--
-- Dumping routines for database 'coloquio_ds_2025'
--
...
-- Dump completed on 2025-10-23 11:32:19
