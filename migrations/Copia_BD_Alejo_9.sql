...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 DROP TRIGGER IF EXISTS `trg_ValidarEstadoProyectoParaPostulacion` */;;
  
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ 
/*!50003 TRIGGER `trg_ValidarEstadoProyectoParaPostulacion` BEFORE INSERT ON `Postulacion`
FOR EACH ROW
BEGIN
...
/*!50003 DROP TRIGGER IF EXISTS `trg_pp_activo_para_postulacion` */;;

/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ 
/*!50003 TRIGGER `trg_pp_activo_para_postulacion` 
...
/*!50003 DROP TRIGGER IF EXISTS `trg_estudiante_carrera_habilitada` */;;

/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ 
/*!50003 TRIGGER `trg_estudiante_carrera_habilitada` 
BEFORE INSERT ON `Postulacion`
FOR EACH ROW
BEGIN
  IF NOT EXISTS (
      SELECT 1
      FROM ProyectoPuestoCarrera ppc
      JOIN EstudianteCarrera ec ON ec.OIDCarrera = ppc.OIDCarrera
      WHERE ppc.OIDProyectoPuesto = NEW.OIDProyectoPuesto
        AND ec.OIDCarrera         = NEW.OIDCarrera
        AND ec.OIDEstudiante      = NEW.OIDEstudiante
  ) THEN
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'No ha sido posible crear la instancia de Postulacion. El Estudiante no cuenta con ninguna carrera habilitada para el Puesto';
  END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 DROP TRIGGER IF EXISTS `trg_proyecto_pertenece_uni_est` */;;

/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ 
/*!50003 TRIGGER `trg_proyecto_pertenece_uni_est` 
BEFORE INSERT ON `Postulacion`
FOR EACH ROW
BEGIN
  IF NOT EXISTS (
      ...
      WHERE eu.OIDEstudiante = NEW.OIDEstudiante
        AND pu.OIDProyecto   = NEW.OIDProyecto
  ) THEN
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'No ha sido posible crear la instancia de Postulacion. El Proyecto no pertenece a la Universidad del Estudiante';
  END IF;
END */;;
DELIMITER ;
...
INSERT INTO `ProcesoSeleccionEstado` VALUES (1,1,1,'2024-09-30','2024-11-25','2024-09-30'),(2,1,1,'2024-10-03','2024-11-25','2024-10-03'),(3,1,1,'2024-10-07','2024-11-25','2024-10-07'),(4,1,1,'2024-10-14','2024-11-25','2024-10-14'),(5,1,2,'2024-11-25','2024-09-30','2024-11-25'),(6,1,2,'2024-12-02','2024-09-30','2024-12-02'),(7,1,3,'2024-09-30','2024-12-09','2024-09-30'),(8,1,3,'2024-10-03','2024-12-09','2024-10-03'),(9,1,3,'2024-10-07','2024-12-09','2024-10-07'),(10,1,3,'2024-10-14','2024-12-09','2024-10-14'),(11,1,3,'2024-11-25','2024-12-09','2024-11-25'),(12,1,3,'2024-12-02','2024-12-09','2024-12-02'),(13,1,4,'2024-12-09',NULL,'2024-12-09'),(14,2,1,'2025-02-10','2025-03-10','2025-02-10'),(15,2,1,'2025-02-17','2025-03-10','2025-02-17'),(16,2,1,'2025-02-24','2025-03-10','2025-02-24'),(17,2,1,'2025-02-27','2025-03-10','2025-02-27'),(18,2,2,'2025-03-10','2025-02-10','2025-03-10'),(19,2,2,'2025-03-17','2025-02-10','2025-03-17'),(20,2,3,'2025-02-10','2025-04-28','2025-02-10'),(21,2,3,'2025-02-17','2025-04-28','2025-02-17'),(22,2,3,'2025-02-24','2025-04-28','2025-02-24'),(23,2,3,'2025-02-27','2025-04-28','2025-02-27'),(24,2,3,'2025-03-10','2025-04-28','2025-03-10'),(25,2,3,'2025-03-17','2025-04-28','2025-03-17'),(26,3,1,'2024-09-09','2024-10-07','2024-09-09'),(27,3,1,'2024-09-16','2024-10-07','2024-09-16'),(28,3,1,'2024-09-23','2024-10-07','2024-09-23'),(29,3,1,'2024-09-26','2024-10-07','2024-09-26'),(30,3,2,'2024-10-07','2024-09-09','2024-10-07'),(31,3,2,'2024-10-14','2024-09-09','2024-10-14'),(32,3,3,'2024-09-09','2024-12-02','2024-09-09'),(33,3,3,'2024-09-16','2024-12-02','2024-09-16'),(34,3,3,'2024-09-23','2024-12-02','2024-09-23'),(35,3,3,'2024-09-26','2024-12-02','2024-09-26'),(36,3,3,'2024-10-07','2024-12-02','2024-10-07'),(37,3,3,'2024-10-14','2024-12-02','2024-10-14'),(38,3,4,'2024-12-02',NULL,'2024-12-02'),(39,4,1,'2024-09-30','2024-10-21','2024-09-30'),(40,4,1,'2024-10-03','2024-10-21','2024-10-03'),(41,4,1,'2024-10-07','2024-10-21','2024-10-07'),(42,4,1,'2024-10-10','2024-10-21','2024-10-10'),(43,4,2,'2024-10-21','2024-09-30','2024-10-21'),(44,4,2,'2024-10-28','2024-09-30','2024-10-28'),(45,4,3,'2024-09-30','2024-11-11','2024-09-30'),(46,4,3,'2024-10-03','2024-11-11','2024-10-03'),(47,4,3,'2024-10-07','2024-11-11','2024-10-07'),(48,4,3,'2024-10-10','2024-11-11','2024-10-10'),(49,4,3,'2024-10-21','2024-11-11','2024-10-21'),(50,4,3,'2024-10-28','2024-11-11','2024-10-28'),(51,4,4,'2024-11-11',NULL,'2024-11-11');
...
DELIMITER ;;
/*!50003 DROP TRIGGER IF EXISTS `trg_ps_estado_vs_proyecto_ins` */;;

/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ 
/*!50003 TRIGGER `trg_ps_estado_vs_proyecto_ins` 
BEFORE INSERT ON `ProcesoSeleccionEstado`
FOR EACH ROW
BEGIN
...
INSERT INTO ProcesoSeleccionPostulacion VALUES (1,1,33,1,1,3,'PSP001'),(2,2,34,1,1,6,'PSP002'),(3,3,35,1,1,7,'PSP003'),(4,NULL,36,1,1,10,'PSP004'),(5,4,37,1,1,2,'PSP005'),(6,5,38,1,1,4,'PSP006'),(7,6,39,1,1,8,'PSP007'),(8,NULL,40,1,1,12,'PSP008'),(9,7,41,1,1,1,'PSP009'),(10,8,42,1,1,5,'PSP010'),(11,9,43,1,1,9,'PSP011'),(12,NULL,44,1,1,11,'PSP012'),(13,10,45,2,1,2,'PSP013'),(14,11,46,2,1,4,'PSP014'),(15,12,47,2,1,8,'PSP015'),(16,NULL,48,2,1,10,'PSP016'),(17,13,49,2,1,3,'PSP017'),(18,14,50,2,1,5,'PSP018'),(19,15,51,2,1,9,'PSP019'),(20,NULL,52,2,1,12,'PSP020'),(21,16,53,2,1,1,'PSP021'),(22,17,54,2,1,6,'PSP022'),(23,18,55,2,1,7,'PSP023'),(24,NULL,56,2,1,11,'PSP024'),(25,19,57,3,2,3,'PSP025'),(26,20,58,3,2,5,'PSP026'),(27,21,59,3,2,7,'PSP027'),(28,NULL,60,3,2,12,'PSP028'),(29,22,61,3,2,2,'PSP029'),(30,23,62,3,2,6,'PSP030'),(31,24,63,3,2,9,'PSP031'),(32,NULL,64,3,2,11,'PSP032'),(33,25,65,3,2,1,'PSP033'),(34,26,66,3,2,4,'PSP034'),(35,27,67,3,2,8,'PSP035'),(36,NULL,68,3,2,10,'PSP036'),(37,28,69,4,2,2,'PSP037'),(38,29,70,4,2,6,'PSP038'),(39,30,71,4,2,7,'PSP039'),(40,NULL,72,4,2,10,'PSP040'),(41,31,73,4,2,1,'PSP041'),(42,32,74,4,2,4,'PSP042'),(43,33,75,4,2,8,'PSP043'),(44,NULL,76,4,2,11,'PSP044'),(45,34,77,4,2,3,'PSP045'),(46,35,78,4,2,5,'PSP046'),(47,36,79,4,2,9,'PSP047'),(48,NULL,80,4,2,12,'PSP048'),(49,37,113,5,3,1,'PSP049'),(50,38,114,5,3,5,'PSP050'),(51,39,115,5,3,9,'PSP051'),(52,NULL,116,5,3,11,'PSP052'),(53,40,117,5,3,3,'PSP053'),(54,41,118,5,3,6,'PSP054'),(55,42,119,5,3,8,'PSP055'),(56,NULL,120,5,3,12,'PSP056'),(57,43,121,5,3,2,'PSP057'),(58,44,122,5,3,4,'PSP058'),(59,45,123,5,3,7,'PSP059'),(60,NULL,124,5,3,10,'PSP060'),(61,46,125,6,3,1,'PSP061'),(62,47,126,6,3,5,'PSP062'),(63,48,127,6,3,8,'PSP063'),(64,NULL,128,6,3,11,'PSP064'),(65,49,129,6,3,3,'PSP065'),(66,50,130,6,3,4,'PSP066'),(67,51,131,6,3,9,'PSP067'),(68,NULL,132,6,3,10,'PSP068'),(69,52,133,6,3,2,'PSP069'),(70,53,134,6,3,6,'PSP070'),(71,54,135,6,3,7,'PSP071'),(72,NULL,136,6,3,12,'PSP072'),(73,55,137,7,4,1,'PSP073'),(74,56,138,7,4,4,'PSP074'),(75,57,139,7,4,9,'PSP075'),(76,NULL,140,7,4,10,'PSP076'),(77,58,141,7,4,2,'PSP077'),(78,59,142,7,4,5,'PSP078'),(79,60,143,7,4,8,'PSP079'),(80,NULL,144,7,4,12,'PSP080'),(81,61,145,7,4,3,'PSP081'),(82,62,146,7,4,6,'PSP082'),(83,63,147,7,4,7,'PSP083'),(84,NULL,148,7,4,11,'PSP084'),(85,64,149,8,4,2,'PSP085'),(86,65,150,8,4,4,'PSP086'),(87,66,151,8,4,9,'PSP087'),(88,NULL,152,8,4,11,'PSP088'),(89,67,153,8,4,3,'PSP089'),(90,68,154,8,4,6,'PSP090'),(91,69,155,8,4,8,'PSP091'),(92,NULL,156,8,4,12,'PSP092'),(93,70,157,8,4,1,'PSP093'),(94,71,158,8,4,5,'PSP094'),(95,72,159,8,4,7,'PSP095'),(96,NULL,160,8,4,10,'PSP096');
